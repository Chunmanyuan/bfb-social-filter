...
KEYWORDS = "AI"  # Keyword search configuration, separated by English commas
LOGIN_TYPE = "qrcode"  # qrcode or phone or cookie
COOKIES = ""
CRAWLER_TYPE = "search"  # search / detail / creator
CRAWLER_MAX_NOTES_COUNT = 10  # Note: Search only supports crawler note maximum count, setting max count avoids getting limited

# [New Features] 初筛专用配置
MAX_VIDEO_SIZE_MB = 100  # 最大允许下载的视频大小 (MB)
FILTER_TIME_RANGE = {
    # 如果 enable 为 False 则禁用时间初筛
    "enable": True,
    # 需要业务调度层自行注入正确的 UNIX 10位精确到秒时间戳
    "start_timestamp_s": 0,
    "end_timestamp_s": 0
}
TASK_ID = None  # 批次号，由 crawler_module.run() 自动生成，格式如 20260228-A3F7
